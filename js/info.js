...
function d7() {
  var x = document.getElementById("d7");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
...
function d8() {
  var x = document.getElementById("d8");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
...
function d9() {
  var x = document.getElementById("d9");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
...
function d10() {
  var x = document.getElementById("d10");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
...
function d11() {
  var x = document.getElementById("d11");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
